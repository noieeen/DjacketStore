...
export default {
  ...
  async mounted() {
    ...
    this.stripe_pk = "pk_test_51LlyLZFOGO7J1192Okwoe4f8ihvtcmm9cidVqRRK7mMIfudQJOdRou2vjRLRZDO53vkha17eJ5hqbXXqacWH5QfI005sBg17NI"
    ...
    //     .then((response) => {
    //       console.log("intialize", response.data);
    //     })
    //     .catch((error) => {
    //       console.log(error);
    //     });
